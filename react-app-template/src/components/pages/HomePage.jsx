...
export default () => (
  <Page>
    <Navbar>
      ...
      <NavTitle>Ethereum/IPFS Javascript Storage Service Demo</NavTitle>
      <NavRight>
    ...
    <Block strong>
      <p>Here is your Ethereum/IPFS Javascript Storage Service Demo. Let's see what we have here.</p>
    </Block>
